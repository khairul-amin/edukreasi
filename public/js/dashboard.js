    ...
    return `
      <tr class="border-b border-white/5 align-top last:border-b-0">
        ...
        <td class="px-5 py-4">
          ...
          <div title="${escapeHtml(row.token || '')}" style="display:inline-block; max-width:11rem; overflow:hidden; white-space:nowrap; text-overflow:ellipsis;" class="mt-2 text-[11px] leading-5 text-white">${escapeHtml(shortenToken(row.token))}</div>
