    ...
    return `
      <tr class="border-b border-white/5 align-top last:border-b-0">
        ...
        <td class="px-5 py-4">
          ...
          <div title="${escapeHtml(row.token || '')}" class="mt-2 block max-w-[11rem] overflow-hidden whitespace-nowrap text-ellipsis text-[11px] leading-5 text-white">${escapeHtml(shortenToken(row.token))}</div>
